package com.ln.demo.equip.provider.system;
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("file:" + confHome + "/spring/applicationContext.xml");
        //confHome="D:\vue+springboot\new-new\dubbo-demo-server-master\dubbo-demo-equip-system-provider\src\main\conf";
